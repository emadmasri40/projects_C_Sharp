...
namespace memory2
{
    public partial class Worest_fit : Form
    {
        Graphics p;
        ...
        public Worest_fit(int flag1, List<node> g, long mem_size1, long number1)
        {
            InitializeComponent();
            list_hole1 = null;
            list_hole1 = g;
        ...
        private void Worest_fit_Load(object sender, EventArgs e)
        {
            ADD.Hide();
            Delete.Hide();
            textBox6.Hide();
